...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      const [animeRes, gameRes, newsRes] = await Promise.all([
        api.api.anime.get(),
        api.api.games.get(),
        api.api.news.get()
      ]);
  ...
  const { favoriteAnime, topGame, news } = data;
    ...
    <div className="min-h-screen p-4 md:p-8 max-w-7xl mx-auto space-y-8 pb-24">
      <header className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <nav className="manga-panel bg-black text-white flex flex-col items-center justify-center space-y-4">
           <Link to="/anime" className="text-2xl font-black italic uppercase hover:text-purple-400 transition-colors flex items-center gap-2 w-full justify-center border-b border-white pb-2">
             <BookOpen /> Anime List
           </Link>
           <Link to="/games" className="text-2xl font-black italic uppercase hover:text-pink-400 transition-colors flex items-center gap-2 w-full justify-center">
             <Gamepad2 /> Game Vault
           </Link>
        </nav>
      </header>
            ...
            <div className="manga-panel relative group overflow-hidden bg-zinc-100 min-h-[300px]">
              ...
              <div className="relative z-10 flex gap-6 h-full">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  ...
                  <Link to="/anime" className="mt-4 inline-flex items-center gap-2 font-black uppercase bg-black text-white px-4 py-2 self-start hover:bg-gray-800 transition-colors">
              ...
              <div className="relative z-10 flex flex-col justify-between h-full">
                ...
                <div className="mt-4 border-t-4 border-black pt-4">
                   ...
                   <div className="mt-4 flex justify-between items-end">
                      ...
                      <Link to="/games" className="inline-flex items-center gap-2 font-black uppercase bg-black text-white px-4 py-2 hover:bg-gray-800 transition-colors">
