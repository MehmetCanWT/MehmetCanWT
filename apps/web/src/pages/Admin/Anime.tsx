...
export default function AdminAnime() {
  ...
  const filtered = data.allAnime.filter((a: any) => 
    ...
    <div className="min-h-screen p-4 md:p-8 max-w-7xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filtered.map((anime: any) => (
          <div key={anime.id} className={`manga-panel relative group ${data.pinnedIds.includes(anime.id) ? "border-purple-600 bg-purple-50" : ""}`}>
            <button 
            ...
            <div className="aspect-[3/4] border-2 border-black overflow-hidden mb-2 bg-black">
